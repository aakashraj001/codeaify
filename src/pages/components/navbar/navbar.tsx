...
const Navbar = ({ scrollToSection, aboutRef, servicesRef, contactRef, homeRef }) => {
  return (
    <header className="bg-white fixed w-full">
      <nav className="flex flex-row items-center justify-between mx-auto h-[15vh] w-[70vw]">
        <div className="flex items-center justify-start gap-8">
          <img
            ...
            aria-label="Logo"
          />
          <NavMenu scrollToSection={scrollToSection} refs={{ aboutRef, servicesRef, contactRef, homeRef }} />
        </div>
